...
export class SettingsToggleDrawer {
    static draw(api: IScreenRenderAPI, settings: GameSettings, selectedIndex: number, x: number, y: number): void {
        NeonTextDrawer.drawNeonText(api, 'SETTINGS', x, y, '#ffffff', '#00ffff', 'bold 28px Arial, sans-serif', 8, 5, 3);
        ...
        api.drawCenteredText('[↑/↓] navigate   [✕] toggle', { x, y: helpY }, '#666688', '14px Arial, sans-serif');
    }
}
